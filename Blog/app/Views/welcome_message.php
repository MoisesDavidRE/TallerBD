...
<header>
    ...
    <div class="menu">
        <ul>
            ...
            <li class="menu-item hidden"><a href="<?php echo base_url('posts/ej1')?>">Ejercicios</a></li>
            <li class="menu-item hidden"><a href="<?php echo base_url('posts/dump')?>"target='_blank'>MYSQL DUMP</a></li>
